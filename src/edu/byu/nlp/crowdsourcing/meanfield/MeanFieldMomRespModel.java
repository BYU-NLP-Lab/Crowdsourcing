 ...
 * @author pfelt
 */
public class MeanFieldMomRespModel implements MeanFieldMultiAnnModel {

  private static final Logger logger = Logger.getLogger(MeanFieldMomRespModel.class.getName());
